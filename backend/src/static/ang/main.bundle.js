...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_navbar_model__ = __webpack_require__(139);
...
var ContentComponent = (function () {
    ...
    ContentComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap
            ...
            .subscribe(function (nav) { return _this.navbar = nav; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ng_bootstrap_ng_bootstrap__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__html_content_html_content_component__ = __webpack_require__(182);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__content_component__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__blog_blog_component__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__blog_list_item_blog_list_item_component__ = __webpack_require__(179);
...
var PageComponent = (function () {
    function PageComponent(navService, route, location) {
        ...
        this.route = route;
        this.location = location;
        this.page = new __WEBPACK_IMPORTED_MODULE_5__models_page_model__["a" /* Page */]({});
    }
...
var Page = (function (_super) {
    ...
    function Page(obj) {
        ...
        _this.nav_url = obj && obj.nav_url || '';
        _this.body = obj && obj.body || null;
        return _this;
    }
    return Page;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_navbar_model__ = __webpack_require__(139);
    ...
    NavService.prototype.getNavbar = function () {
        ...
        var promise = new Promise(function (resolve, reject) {
            _this.http.get(_this.base_url + 'navbar/')
                .toPromise()
                .then(function (res) {
                resolve(new __WEBPACK_IMPORTED_MODULE_3__models_navbar_model__["a" /* Navbar */](res.json()));
            });
        });
        return promise;
    };
